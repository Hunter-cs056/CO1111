...
Maximos will start the html and the js of the App page(app.html)
Rudolf will complete maximos js for the App page(app.html)
Alexandra will start the html of the landing page(index.html)
Rania and george will start the css for both of the pages and 
